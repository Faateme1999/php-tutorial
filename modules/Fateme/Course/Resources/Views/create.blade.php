    ...
    <div class="row no-gutters  ">
        <div class="col-12 bg-white">
            ...
            <form action="{{ route('courses.store') }}" class="padding-30" method="post" enctype="multipart/form-data">
                ...
                @if(hasPermissionTo(Fateme\RolePermissions\Models\Permission::PERMISSION_MANAGE_COURSES))
                ...
                <x-select name="type" required>
                    ...
                    @foreach(\Fateme\Course\Models\Course::$types as $type)
                        <option value="{{ $type }}"
                ...
                <x-select name="status" required>
                    ...
                    @foreach(\Fateme\Course\Models\Course::$statuses as $status)
                        <option value="{{ $status }}"
...
@endsection@extends('Dashboard::master')
@section('breadcrumb')
    <li><a href="{{ route('courses.index') }}" title="دوره ها">دوره ها</a></li>
    <li><a href="#" title="ایجاد دوره">ایجاد دوره</a></li>
@endsection
